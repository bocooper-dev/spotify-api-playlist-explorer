<template>
  <div class="space-y-4">
    <!-- Results Summary -->
    <div v-if="playlists.length > 0" class="flex justify-between items-center">
    ...
    <!-- Results Table -->
    <div v-if="playlists.length > 0" class="overflow-x-auto" data-testid="results-table">
          ...
          >
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center">
                <div v-if="playlist.imageUrl" class="flex-shrink-0 h-12 w-12">
                  <img
                ...
                <div :class="playlist.imageUrl ? 'ml-4' : ''">
                  <div class="text-sm font-medium text-gray-900 dark:text-white" data-testid="playlist-name">
                    {{ playlist.name }}
                  </div>
                  <div v-if="playlist.genres.length > 0" class="flex flex-wrap gap-1 mt-1">
                    <UBadge
            ...
            <!-- Followers -->
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="text-sm font-medium text-gray-900 dark:text-white" data-testid="playlist-followers">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center">
                <div v-if="playlist.owner.imageUrl" class="flex-shrink-0 h-8 w-8">
                  <img
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              ...
              >
                <UIcon name="i-simple-icons-spotify" class="w-3 h-3 mr-1" />
                Open in Spotify
              </a>
            </td>
          </tr>
    ...
    <div v-if="isLoading" class="text-center py-12" data-testid="loading-state">
      <UIcon name="i-heroicons-arrow-path" class="mx-auto h-8 w-8 text-gray-400 animate-spin mb-4" />
