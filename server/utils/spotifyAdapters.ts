...
/**
 * Converts Spotify SDK SimplifiedPlaylist to internal Playlist type
 * 
 * @param sdkPlaylist SDK playlist object
 * @param genres Associated genres from search context
 * @returns Internal Playlist object
 */
export function adaptSpotifyPlaylist(sdkPlaylist: SimplifiedPlaylist, genres: string[] = []): Playlist {
  return {
    id: sdkPlaylist.id,
 ...
 */
export function adaptSpotifyPlaylists(sdkPlaylists: SimplifiedPlaylist[], searchGenres: string[] = []): Playlist[] {
 ...
 */
export function validateSpotifyPlaylist(sdkPlaylist: any): sdkPlaylist is SimplifiedPlaylist {
  return (
    sdkPlaylist &&
